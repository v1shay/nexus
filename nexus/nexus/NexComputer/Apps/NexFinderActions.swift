...
actor NexFinderActionCatalog {
    ...
    private static let moveManifest = mutation("finder.move", "Move one file or folder into an allowed directory with explicit collision handling.", ["Move this into Archive"])
